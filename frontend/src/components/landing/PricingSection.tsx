...
export default function PricingSection({ t, currency, onProtocolOpen, onContactClick, onGenesisClick }: PricingSectionProps) {
    return (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Reveal delay={0}>
                        <div className="card-elevated p-8 h-full bg-white">
                            ...
                            <ul className="space-y-3 mb-8">
                                {t.pricing.tier1_features.map((f: string, i: number) => (
                    ...
                    <Reveal delay={0.1}>
                        <div className="card-featured p-8 h-full relative">
                            ...
                            <ul className="space-y-3 mb-8">
                                {t.pricing.tier2_features.map((f: string, i: number) => (
                    ...
                    <Reveal delay={0.2}>
                        <div className="card-elevated p-8 h-full bg-white">
                            ...
                            <ul className="space-y-3 mb-8">
                                {t.pricing.tier3_features.map((f: string, i: number) => (
                                    <li key={i} className="flex items-center gap-2 text-sm text-slate-600 font-medium">
