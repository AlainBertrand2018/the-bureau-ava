...
/* ═══════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════ */
export default function AVAGatewayClient() {
    const router = useRouter();
                ...
                <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-lg lg:max-w-xl">
                    ...
                    <AnimatePresence>
                        {showSubtitle && (
                            ...
                            >
                                Your <span className={dark ? "text-white" : "text-slate-900"}>A</span>utonomous <span className={dark ? "text-white" : "text-slate-900"}>V</span>alidation <span className={dark ? "text-white" : "text-slate-900"}>A</span>nalyst
                            </motion.p>
                        )}
                    </AnimatePresence>
                    ...
                    <AnimatePresence>
                        {showBody && (
                            ...
                            >
                                I provide a skillful suite of Agentic AI protocols designed for executive-grade survey optimization. By deploying synthetic populations for adversarial instrument auditing, I secure data integrity for Government, FMCG, and Academic research—ensuring every questionnaire is statistically rigorous and fieldwork-ready.
                            </motion.p>
                        )}
                    </AnimatePresence>
