...
// --- Reusable UI Entities (Bureau Style) ---
...
export default function FieldInterpreterPage() {
    ...
    const startAnalysis = () => {
        ...
        // Simulation of multi-agent validation
        setTimeout(() => {
    ...
    return (
        <div className="min-h-screen bg-black text-white p-8">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {(step === 'processing' || step === 'results') && (
                            <motion.div
                                ...
                                className="space-y-6"
                            >
                                {/* Result Summary Bar (only visible when results done) */}
                                <AnimatePresence>
                                    {step === 'results' && (
                                        <motion.div
                                            initial={{ height: 0, opacity: 0 }}
                ...
                {/* Right Column: Agentic Council Sidebar */}
